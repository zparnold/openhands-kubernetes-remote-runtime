...
The runtime API automatically cleans up orphaned resources to prevent resource leaks and maintain cluster health. The cleanup service runs periodically and removes:
